...
1. Установите зависимости (нужен Node 20+ — Vercel использует эту версию для сборки):
   ...
   npm run dev
   ```
   > Если при установке видите ошибку `No matching version found for @twa-dev/sdk`, обновите зависимости — пакет закреплен на стабильной ветке `^7.10.0` и не требует RC-версий.
